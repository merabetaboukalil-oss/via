/**
 * VIA Local Link Agent - V1.8.1 (Physical Printer Edition)
 */
    ...
    if (req.method === 'GET' && reqURL.pathname === '/') {
      ...
      res.end(`
        ...
        <html lang="fr">
          ...
          <body>
            <div class="container">
              <h1>VIA Agent <span class="badge">V1.8.1</span></h1>
                ...
                <div style="margin-top: 20px;">
                  ...
                  <ul style="font-size: 0.95em; color: #cbd5e1; list-style: none; padding-left: 10px;">
                    ...
                    <li style="color: #fb7185; margin-top: 10px; font-weight: bold; border-left: 3px solid #fb7185; padding-left: 10px;">
                      ⚠️ POURQUOI LE PORT 515 EST GELÉ (PHOTO CAP_6) ?<br>
                      Windows a détecté l'Agent comme une adresse IP simple et a créé un port "TCP/IP Standard" (LPR/515).<br>
                      <strong>CE PORT EST INUTILE ET NE PEUT PAS ÊTRE MODIFIÉ MANUELLEMENT EN PORT 631.</strong><br>
                      <br>
                      ➜ <strong>SOLUTION UNIQUE :</strong> Vous devez supprimer l'imprimante et recommencer avec la méthode <strong>"Imprimante partagée par nom"</strong> comme indiqué ci-dessous.
                    </li>
                    <li style="color: #60a5fa; margin-top: 15px; border-left: 3px solid #60a5fa; padding-left: 10px;">
                      🚀 <strong>MÉTHODE POUR FORCER LE PORT 631 (IPP) :</strong><br>
                      1. Supprimez l'imprimante actuelle (celle qui affiche Port 515).<br>
                      ...
                      4. Cochez <strong>"Sélectionner une imprimante partagée par son nom"</strong>.<br>
                      5. Collez l'URL : <code>http://${localIP}:631/ipp/print</code><br>
                      6. Windows créera alors un port HTTP spécial, et non un port TCP/IP 515.
                    </li>
                  </ul>
                </div>
              </div>
        ...
        req.on('end', async () => {
          ...
          if (opId === 0x0002) { // Print-Job
            ...
            if (endTagIndex !== -1) {
              ...
              // Réponse IPP Professionnelle V1.7.3 (Bridge Mode)
...
server.listen(IPP_PORT, '0.0.0.0', async () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.8.1 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
