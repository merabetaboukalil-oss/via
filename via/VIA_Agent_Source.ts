/**
 * VIA Local Link Agent - V1.7.3 (Universal Connect Pro)
 */
    ...
    if (req.method === 'GET' && reqURL.pathname === '/') {
      ...
      res.end(`
        ...
        <html lang="fr">
          ...
          <body>
            <div class="container">
              <h1>VIA Agent <span class="badge">V1.7.3</span></h1>
                ...
                <div style="margin-top: 20px;">
                  ...
                  <ul style="font-size: 0.95em; color: #cbd5e1; list-style: none; padding-left: 10px;">
                    ...
                    <li style="color: #fb7185; margin-top: 10px; font-weight: bold; border-left: 3px solid #fb7185; padding-left: 10px;">
                      ⚠️ SI VOUS AVEZ UNE ERREUR (Paramètre incorrect / Runtime) :<br>
                      1. Gérer > Propriétés de l'imprimante (Avancé).<br>
                      2. <strong>DÉCOCHEZ</strong> "Activer les fonctionnalités d'impression avancées".<br>
                      3. Dans la liste Pilote, choisissez <strong>"Generic / Text Only"</strong>.<br>
                      4. Cliquez sur Appliquer.
                    </li>
                    <li style="color: #60a5fa; margin-top: 15px; border-left: 3px solid #60a5fa; padding-left: 10px;">
                      ⚠️ ERREUR PORT (PHOTO CAP_6) :<br>
                      <strong>SURTOUT PAS</strong> de "Port TCP/IP Standard" !<br>
                      Windows gère l'IPP nativement via l'URL HTTP.<br>
                      <br>
                      🚀 <strong>LA MÉTHODE LA PLUS FIABLE :</strong><br>
                      Ouvrez <strong>PowerShell en Administrateur</strong> et collez :<br>
                      <div style="background: #000; padding: 10px; margin-top: 5px; font-family: monospace; font-size: 0.8em; color: #60a5fa; border-radius: 4px; word-break: break-all;">
                        Add-Printer -Name "VIA-Bridge" -ConnectionName "http://${localIP}:631/ipp/print"
                      </div>
                    </li>
                  </ul>
                </div>
...
server.listen(IPP_PORT, '0.0.0.0', async () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.7.3 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
