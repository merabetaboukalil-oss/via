/**
 * VIA Local Link Agent - V1.5.4 (Debug Firewall)
 * 
 * INSTALLATION :
...
async function fixWindowsFirewall() {
  try {
    ...
    // Ajout de -NoExit pour que l'utilisateur puisse lire l'erreur si elle survient
  ...
  return http.createServer((req, res) => {
    ...
    const html = `
      ...
      <html lang="fr">
        ...
        <body>
          <div class="container">
            <h1>VIA Agent <span class="badge">V1.5.4</span></h1>
...
server.listen(IPP_PORT, '0.0.0.0', async () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.5.4 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
