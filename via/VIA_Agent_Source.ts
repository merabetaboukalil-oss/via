/**
 * VIA Local Link Agent - V1.6.2 (Deep Sync Pro)
 */
    ...
    if (req.method === 'GET' && reqURL.pathname === '/') {
      ...
      res.end(`
        ...
        <html lang="fr">
          ...
          <body>
            <div class="container">
              <h1>VIA Agent <span class="badge">V1.6.2</span></h1>
...
server.listen(IPP_PORT, '0.0.0.0', async () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.6.2 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
