 ...
 * 
 * INSTALLATION LOCALE :
 * Avant de lancer l'agent, exécutez cette commande dans votre terminal :
 * npm install socket.io-client bonjour-service
 * 
...
server.listen(IPP_PORT, '0.0.0.0', () => {
  ...
  try {
    ...
    console.warn("[NETWORK] Échec du partage mDNS:", e);
  }
});
