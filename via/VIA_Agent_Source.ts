/**
 * VIA Local Link Agent - V1.8.2 (Professional Bridge)
 */
    ...
    if (req.method === 'GET' && reqURL.pathname === '/') {
      ...
      res.end(`
        ...
        <html lang="fr">
          ...
          <body>
            <div class="container">
              <h1>VIA Agent <span class="badge">V1.8.2</span></h1>
        ...
        req.on('end', async () => {
          ...
          if (opId === 0x0002) { // Print-Job
            ...
            if (endTagIndex !== -1) {
              ...
              // Réponse IPP Professionnelle V1.8.2 (Bridge Mode)
...
server.listen(IPP_PORT, '0.0.0.0', async () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.8.2 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
