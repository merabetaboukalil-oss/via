/**
 * VIA Local Link Agent - V1.4.9 (Local Dashboard)
 * 
  ...
  return http.createServer((req, res) => {
    ...
    const html = `
      ...
      <html lang="fr">
        ...
        <body>
          <div class="container">
            <h1>VIA Agent <span class="badge">V1.4.9</span></h1>
...
server.listen(IPP_PORT, '0.0.0.0', async () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.4.9 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
