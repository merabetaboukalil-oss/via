/**
 * VIA Local Link Agent - V1.8.0 (Physical Printer Edition)
 */
    ...
    if (req.method === 'GET' && reqURL.pathname === '/') {
      ...
      res.end(`
        ...
        <html lang="fr">
          ...
          <body>
            <div class="container">
              <h1>VIA Agent <span class="badge">V1.8.0</span></h1>
                ...
                <div style="margin-top: 20px;">
                  ...
                  <ul style="font-size: 0.95em; color: #cbd5e1; list-style: none; padding-left: 10px;">
                    ...
                    <li style="color: #fb7185; margin-top: 10px; font-weight: bold; border-left: 3px solid #fb7185; padding-left: 10px;">
                      ⚠️ ERREUR PORT 515 / LPR (PHOTO CAP_6) :<br>
                      Si vous voyez "Port 515" dans les propriétés, c'est une configuration Windows ERRONÉE.<br>
                      L'Agent utilise le port <strong>631</strong> (IPP).<br>
                      <br>
                      ➜ <strong>SOLUTION :</strong> Supprimez l'imprimante dans Windows.<br>
                      ➜ <strong>REFAIRE :</strong> "Ajouter une imprimante" > "L'imprimante que je veux n'est pas répertoriée" > "Sélectionner une imprimante partagée par nom" > Coller l'URL ci-dessus.
                    </li>
                    <li style="color: #60a5fa; margin-top: 15px; border-left: 3px solid #60a5fa; padding-left: 10px;">
                      🚀 <strong>COMMENT FIXER LE PORT (Pas à pas) :</strong><br>
                      1. Supprimez l'imprimante qui est en erreur.<br>
                      ...
                      4. Choisissez <strong>"Sélectionner une imprimante partagée par nom"</strong>.<br>
                      5. Collez l'URL IPP complète : <code>http://${localIP}:631/ipp/print</code><br>
                      6. Windows installera le port HTTP 631 automatiquement.
                    </li>
                  </ul>
                </div>
              </div>
...
server.listen(IPP_PORT, '0.0.0.0', async () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.8.0 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
