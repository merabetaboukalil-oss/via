/**
 * VIA Local Link Agent - V1.4.5 (PowerShell Get-Printer)
 */
...
function createIppServer() {
  return http.createServer((req, res) => {
    ...
    res.writeHead(200);
    res.end('VIA Agent V1.4.5 Active');
  });
}
...
server.listen(IPP_PORT, '0.0.0.0', () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.4.5 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
});