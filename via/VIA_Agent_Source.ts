/**
 * VIA Local Link Agent - V1.6.7 (Universal Hardware Sync)
 */
    ...
    if (req.method === 'GET' && reqURL.pathname === '/') {
      ...
      res.end(`
        ...
        <html lang="fr">
          ...
          <body>
            <div class="container">
              <h1>VIA Agent <span class="badge">V1.6.6</span></h1>
    ...
    if (reqURL.pathname === '/ipp/print') {
      ...
      if (req.method === 'POST') {
        ...
        req.on('end', async () => {
          ...
          // Réponse IPP Professionnelle V1.6.5 (Enterprise Encoding)
...
server.listen(IPP_PORT, '0.0.0.0', async () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.6.7 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
