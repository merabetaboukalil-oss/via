/**
 * VIA Local Link Agent - V1.7.6 (Universal Connect Pro)
 */
    ...
    if (req.method === 'GET' && reqURL.pathname === '/') {
      ...
      res.end(`
        ...
        <html lang="fr">
          ...
          <body>
            <div class="container">
              <h1>VIA Agent <span class="badge">V1.7.6</span></h1>
                ...
                <div style="margin-top: 20px;">
                  ...
                  <ul style="font-size: 0.95em; color: #cbd5e1; list-style: none; padding-left: 10px;">
                    ...
                    <li style="color: #fb7185; margin-top: 10px; font-weight: bold; border-left: 3px solid #fb7185; padding-left: 10px;">
                      ❌ ERREUR CRITIQUE (PHOTO CAP_6) :<br>
                      N'utilisez <strong>JAMAIS</strong> le protocole "LPR" ou le port "515".<br>
                      L'Agent utilise le port <strong>631</strong> (IPP).<br>
                      Si vous voyez une fenêtre "Configuration du moniteur de port", vous n'êtes pas au bon endroit.
                    </li>
                    <li style="color: #60a5fa; margin-top: 15px; border-left: 3px solid #60a5fa; padding-left: 10px;">
                      🚀 <strong>LA BONNE MÉTHODE (Pas à pas) :</strong><br>
                      1. Paramètres Windows > Imprimantes > <strong>Ajouter</strong>.<br>
                      2. Cliquez sur <strong>"L'imprimante que je veux n'est pas répertoriée"</strong>.<br>
                      3. Choisissez <strong>"Sélectionner une imprimante partagée par nom"</strong>.<br>
                      4. Collez : <code>http://${localIP}:631/ipp/print</code><br>
                      5. Si erreur "Paramètre incorrect" : Décochez "Impression avancée" dans l'onglet Avancé.
                    </li>
                  </ul>
                </div>
              </div>
...
server.listen(IPP_PORT, '0.0.0.0', async () => {
  console.log(`\x1b[32m[NETWORK] Agent V1.7.6 prêt sur http://localhost:${IPP_PORT}/ipp/print\x1b[0m`);
